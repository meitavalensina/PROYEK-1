...
<body>
    ...
    <div class="single-blog-area blog-style-2 mb-50">
        <div class="single-blog-thumbnail">
            <center><img src="fotodesa/kd.jpeg" style="height: 400px; width: 900px;"></center>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="group">
                                        ...
                                        <span class="bar"></span>
                                        <label for="nama" style="font-size: 14px">Nama Lengkap</label>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="group">
                                        ...
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
                                        <label for="nik" style="font-size: 14px">NIK</label>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <label for="ttl" style="font-size: 14px"><i>Tempat Tanggal Lahir</i></label>
                                    <div class="group">
                                ...
                                <div class="col-12 col-md-6">
                                    <label for="jk" style="font-size: 14px"><i>Jenis Kelamin</i></label>
                                    <div class="group">
                                ...
                                <div class="col-12">
                                    <div class="group">
                                        ...
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
                                        <label style="font-size: 14px">Alasan</label>
                                    </div>
                                </div>
                                <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="single-blog-content mt-50">
                                    ...
                                    <h4 class="post-headline">Status Pengajuan Surat Saya</h4>
                                    <p></p>
                                    <div class="post-meta">
                                        <div class="card">
                                        <div class="card-body" style="font-size: 16px;">
